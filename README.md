...
| [**`@rxova/react-timezone-input`**](packages/react-timezone-input)<br />[![npm](https://img.shields.io/npm/v/@rxova/react-timezone-input?color=cb3837&label=)](https://www.npmjs.com/package/@rxova/react-timezone-input)                     | IANA time zone picker with no tz database — localised names and live DST offsets | ≤ 3.25 kB |
...
packages/
  ...
  react-timezone-input        IANA time zone picker
