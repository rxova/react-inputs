...
| [**`@rxova/react-measurement-input`**](packages/react-measurement-input)<br />[![npm](https://img.shields.io/npm/v/@rxova/react-measurement-input?color=cb3837&label=)](https://www.npmjs.com/package/@rxova/react-measurement-input)         | Feet and inches, stones and pounds, with exact conversion and no conversion library | ≤ 6.75 kB |
...
packages/
  ...
  react-measurement-input     segmented measurement input
